...
//#define DISPLAY_SIZE_80X160
#define DISPLAY_SIZE_40x80
//#define DISPLAY_SIZE_20x40
...
#endif 
#ifdef DISPLAY_SIZE_20x40
static uint16_t crop_width =  20;
static uint16_t crop_high =  40;
...
/*
display by pixel.
display memory size < lcd display memory size.
*/
